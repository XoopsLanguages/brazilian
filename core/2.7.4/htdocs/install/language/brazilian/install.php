...
define('READY_INSERT_DATA', 'O instalador está pronto para inserir os dados iniciais no seu banco de dados.');
define('READY_CREATE_TABLES', 'Nenhuma tabela XOOPS foi detectada.<br>O instalador está pronto para criar as tabelas do sistema XOOPS.');
define('READY_SAVE_MAINFILE', 'O instalador está pronto para salvar as configurações especificadas em <em>mainfile.php</em>.');
// 2.7.1
