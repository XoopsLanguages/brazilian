...
define('_MI_SYSTEM_BNAME2', 'Menu de Usuário');
define('_MI_SYSTEM_BNAME3', 'Entrar');
define('_MI_SYSTEM_BNAME4', 'Pesquisar');
define('_MI_SYSTEM_BNAME5', 'Conteúdos Pendentes');
...
define('_MI_SYSTEM_BNAME9', 'Principais Postadores');
...
define('_MI_SYSTEM_ADMENU9', 'Classificação de Usuários');
define('_MI_SYSTEM_ADMENU10', 'Editar Usuário');
define('_MI_SYSTEM_ADMENU11', 'Email para Usuários');
define('_MI_SYSTEM_ADMENU12', 'Buscar Usuários');
...
define('_MI_SYSTEM_PREFERENCE_TIPS', 'Ajuda online?');
define('_MI_SYSTEM_PREFERENCE_TIPS_DSC', 'Isso fornece dicas e ajuda online');
define('_MI_SYSTEM_PREFERENCE_ICONS', 'Ícones');
define('_MI_SYSTEM_PREFERENCE_BREADCRUMB', 'Trilha de navegação');
define('_MI_SYSTEM_PREFERENCE_BREAK_ACTIVE', 'Seção Ativa');
...
define('_MI_SYSTEM_PREFERENCE_ACTIVE_IMAGES', 'Gerenciador de Imagens Ativo');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_MAILUSERS', 'Email para Usuários Ativo');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_MODULESADMIN', '');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_PREFERENCES', '');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_SMILIES', 'Emoticons Ativos');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_TPLSETS', '');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_USERRANK', 'Classificação de Usuários Ativa');
...
define('_MI_SYSTEM_PREFERENCE_BREAK_PAGER', 'Número de linhas para exibir na administração');
define('_MI_SYSTEM_PREFERENCE_AVATARS_PAGER', 'Número de avatares para exibir por página');
define('_MI_SYSTEM_PREFERENCE_BANNERS_PAGER', 'Número de banners para exibir por página');
define('_MI_SYSTEM_PREFERENCE_COMMENTS_PAGER', 'Número de comentários para exibir por página');
define('_MI_SYSTEM_PREFERENCE_GROUPS_PAGER', 'Número de grupos para exibir por página');
define('_MI_SYSTEM_PREFERENCE_IMAGES_PAGER', 'Número de imagens para exibir por página');
define('_MI_SYSTEM_PREFERENCE_SMILIES_PAGER', 'Número de emoticons para exibir por página');
define('_MI_SYSTEM_PREFERENCE_USERRANKS_PAGER', 'Número de classificações para exibir por página');
define('_MI_SYSTEM_PREFERENCE_USERS_PAGER', 'Número de usuários para exibir por página');
...
// 2.5.11
define('_MI_DEFAULT_NOTIFICATION_METHOD_DISABLE', 'Desabilitar temporariamente');
...
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Gerencie o registro de localidades, pacotes de idiomas, verificações de integridade e substituições de tradução do site.');
define('_MI_SYSTEM_BNAME14', 'Alternador de idiomas');
